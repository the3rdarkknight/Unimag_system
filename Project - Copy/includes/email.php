...
// YOUR GMAIL SETTINGS
define('MAIL_FROM',      'denversoi90@gmail.com');  
define('MAIL_FROM_NAME', 'UniMag System');           
define('MAIL_PASSWORD',  'lcdz vnso rvra suqq');                  // 16-char Gmail App Password
// 
...
function sendEmail(string $to, string $toName, string $subject, string $htmlBody): bool {
    ...
    try {
        ...
        error_log("UniMag email failed to $to: " . $mail->ErrorInfo);
        return false;
    }
}
